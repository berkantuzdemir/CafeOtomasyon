          ...
          <div class="">
                    ...
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="hakkimizda_baslik" value="<?php echo $hakkimizdacek['hakkimizda_baslik']?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
            ...
            <!-- Ck Editör Bitiş -->
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="hakkimizda_video" value="<?php echo $hakkimizdacek['hakkimizda_video']?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="hakkimizda_misyon" value="<?php echo $hakkimizdacek['hakkimizda_misyon']?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="hakkimizda_vizyon" value="<?php echo $hakkimizdacek['hakkimizda_vizyon']?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
