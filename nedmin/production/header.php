        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div align="center" class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"></i> <span>ADMİN PANELİ</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cogs"></i>Ayarlar <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="iletişim-ayarlar.php">İletişim Ayarları</a></li>
                      <li><a href="sosyal-ayarlar.php">Sosyal Medya Ayarları</a></li>
                      <li><a href="mail-ayarlar.php">Mail Ayarları</a></li>
                    </ul>
                  </li>
                  <li><a href="hakkimizda.php"><i class="fa fa-info"></i> Hakkımızda</a>
                  </li>
                  <li><a href="kullanici.php"><i class="fa fa-users"></i> Kullanıcılar</a>
                    
                  </li>
                  <li><a href="urun.php"><i class="fa fa-shopping-cart"></i> Ürünler</span></a></li>
                </ul>
              </div>
